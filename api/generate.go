...
//go:generate go run github.com/oapi-codegen/oapi-codegen/v2/cmd/oapi-codegen --generate types -o types.gen.go -package=api --import-mapping=decimal:github.com/shopspring/decimal.Decimal api.yaml
